...
class LotteriesControllerTest < ActionController::TestCase
  ...
  test "should create lottery" do
    assert_difference('Lottery.count') do
      post :create, lottery: { end_date: @lottery.end_date, name: @lottery.name, start_date: @lottery.start_date, state: @lottery.state, winning_number: @lottery.winning_number }
    end
  ...
  test "should update lottery" do
    patch :update, id: @lottery, lottery: { end_date: @lottery.end_date, name: @lottery.name, start_date: @lottery.start_date, state: @lottery.state, winning_number: @lottery.winning_number }
    assert_redirected_to lottery_path(assigns(:lottery))
  end
